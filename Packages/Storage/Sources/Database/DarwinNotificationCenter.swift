...
extension DarwinNotification.Name {
    ...
    private static var extensionDidSaveManagedObjectContext: DarwinNotification.Name {
        return DarwinNotification.Name("com.thoughtworks.appBundleIdentifier")
    }
    ...
    private static var appDidSaveManagedObjectContext: DarwinNotification.Name {
        return DarwinNotification.Name("com.thoughtworks.Catalyst-iOS-Starter-CleanArchitecture.watchkitapp.watchkitextension")
    }
}
...
public final class DarwinNotificationCenter {
    ...
    private let queue = DispatchQueue(label: "com.thoughtworks.darwin-notificationcenter", qos: .default, attributes: [], autoreleaseFrequency: .workItem)
